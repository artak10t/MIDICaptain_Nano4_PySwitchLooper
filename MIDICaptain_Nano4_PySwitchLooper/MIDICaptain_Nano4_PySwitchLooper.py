...
class MIDICaptain_Nano4_PySwitchLooper(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for MIDICaptain_Nano4_PySwitchLooper in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in MIDICaptain_Nano4_PySwitchLooper._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in MIDICaptain_Nano4_PySwitchLooper._active_instances:    # Make sure you update the name
            MIDICaptain_Nano4_PySwitchLooper._active_instances.append(self)   # Make sure you update the name
            MIDICaptain_Nano4_PySwitchLooper._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in MIDICaptain_Nano4_PySwitchLooper._active_instances) and MIDICaptain_Nano4_PySwitchLooper._active_instances.remove(self):    # Make sure you update the name
    ...
    def _setup_device_and_transport_control(self):
        ...
        transport.set_session_record_button(self._note_map[SESSION_RECORD])
